            ...
            {!isLoading && !!stats?.data.length && (
                <>
                    <Row gutter={[16, 16]} style={{ marginBottom: 16 }}>
                        ...
                        <Col><b>Çatdırılma:</b> {stats.total.deliveryPrice.toFixed(2)} ₼</Col>
                    </Row>
                    {view === 'chart' && (
                        <StatisticsLineChart
                    ...
                    {view === 'table' && (
                        <Table
                            ...
                            columns={[
                                ...
                                { title: 'Qiymət (₺)', dataIndex: 'productPrice', key: 'price', render: (v) => v.toFixed(2) },
                                { title: 'Çatdırılma (₼)', dataIndex: 'deliveryPrice', key: 'delivery', render: (v) => v.toFixed(2) },
                            ]}
                        />
                    )}
                </>
