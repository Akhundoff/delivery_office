...
export const PlansActionBar = () => {
  ...
  const { handleFetch, handleReset } = useContext(PlansTableContext);
  return (
    <HeadPortal>
      <StyledActionBar $flex={true}>
        <Space>
          <StyledHeaderButton type="text" onClick={() => navigate("/plans/create", { withBackground: true })} icon={<Icons.PlusCircleOutlined />}>Yeni</StyledHeaderButton>
