...
const SmsStatusCell: FC<{ original: ISmsNotification }> = ({ original }) => {
...
export const useSmsNotificationsTableColumns = (): Column<ISmsNotification>[] =>
    useMemo(
        () => [
            ...
            { ...nextTableColumns.small, Header: 'Müştəri kodu', id: 'user_id', accessor: (r) => r.userId },
            {
                ...
                id: 'sent',
                accessor: (r) => r.sent,
                Cell: ({ row: { original } }: any) => <SmsStatusCell original={original} />,
            },
