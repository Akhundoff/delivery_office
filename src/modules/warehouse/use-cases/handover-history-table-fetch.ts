...
export const handoverHistoryTableFetchUseCase = (params: NextTableFetchParams) => async (dispatch: Dispatch<NextTableActions>) => {
    dispatch(nextTableFetchDataStartedAction());
    const result = await WarehouseService.getHandoverQueues({ ...tableQueryMaker(params), state_id: ['43'] });
