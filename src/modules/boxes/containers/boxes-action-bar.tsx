...
export const BoxesActionBar = () => {
  ...
  const { handleFetch, handleReset } = useContext(BoxesTableContext);
  return (
    <HeadPortal>
      <StyledActionBar $flex={true}>
        <Space>
          <StyledHeaderButton type="text" onClick={() => navigate("/boxes/create", { withBackground: true })} icon={<Icons.PlusCircleOutlined />}>Yeni</StyledHeaderButton>
