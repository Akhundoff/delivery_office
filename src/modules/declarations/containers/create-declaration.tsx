        ...
        <Row gutter={[24, 0]}>
          ...
          <Col xs={24} md={18}>
            <Row gutter={[16, 0]} style={{ paddingTop: 30 }}>
              ...
              <Col>
                <CheckboxField name="isCommercial" input={{ children: 'Kommersial' }} />
              </Col>
              <Col>
                <CheckboxField name="isSpecial" input={{ children: 'Xüsusi tarif', disabled: !can('changedeliveryprice') }} />
              </Col>
            </Row>
          </Col>
          {values.isSpecial && (
            <Col xs={24} md={12}>
              <SelectField name="planTypeId" item={{ label: 'Tarif kateqoriyası' }} input={{ placeholder: 'Tarif kateqoriyası seçin', disabled: !can('changedeliveryprice') }}>
                {planCategoryOptions}
              </SelectField>
            </Col>
          )}
          <Col xs={24}>
            <Form.Item label="Qeyd">
              <Input.TextArea placeholder="Qeyd daxil edin..." rows={3} value={values.description} onChange={(e) => setFieldValue('description', e.target.value)} />
            </Form.Item>
          </Col>
        </Row>
      </Form>
