import { IDeclaration, IDeclarationFormValues, IDeclarationPersistence } from '../interfaces';

export class DeclarationMapper {
  public static toPersistence(values: IDeclarationFormValues, id?: string | number): Record<string, any> {
    return {
      ...(id != null ? { declaration_id: String(id), container_id: values.boxId } : {}),
      user_id: values.userId,
      measure_id: '1',
      global_track_code: values.globalTrackCode,
      product_type_id: values.productTypeId,
      quantity: values.quantity,
      is_special: Number(values.isSpecial).toString(),
      is_commercial: Number(values.isCommercial).toString(),
      tariff_category_id: values.planTypeId,
  ...
  public static toDomain(d: IDeclarationPersistence): IDeclaration {
    return {
      ...
      basket: d.basket_id ? { id: d.basket_id, name: d.basket_name || '' } : null,
      box: d.container_id && d.container_name ? { id: d.container_id, name: d.container_name } : null,
      lastBox: d.container_id_tmp && d.container_name_tmp ? { id: d.container_id_tmp, name: d.container_name_tmp } : null,
      branch: d.branch_id ? { id: d.branch_id, name: d.branch_name || '' } : null,
      quantity: d.quantity,
      ...
      flight: d.flight_name ? { id: d.flight_id || 0, name: d.flight_name } : null,
      ...
      deliveryPoint: d.delivery_point_id ? { id: d.delivery_point_id, name: d.delivery_point_name || '' } : null,
      trendyol: d.trendyol,
