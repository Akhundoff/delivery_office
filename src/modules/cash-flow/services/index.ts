...
export class CashRegistersService {
    ...
    public static async create(dto: { id?: string; name: string; amount: string; currencyId: string }): Promise<ApiResult<200, null> | ApiResult<422, Record<string, string>> | ApiResult<400 | 500, string>> {
        ...
        try {
            ...
            if (response.status === 400 && errBody.errors) {
                ...
                Object.entries(errBody.errors).forEach(([k, v]) => { errors[k] = (v as string[]).join('. '); });
