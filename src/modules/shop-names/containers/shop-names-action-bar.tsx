...
export const ShopNamesActionBar = () => {
  ...
  const { handleFetch, handleReset } = useContext(ShopNamesTableContext);
  return (
    <HeadPortal>
      <StyledActionBar $flex={true}>
        <Space>
          <StyledHeaderButton type="text" onClick={() => navigate("/shop-names/create", { withBackground: true })} icon={<Icons.PlusCircleOutlined />}>Yeni</StyledHeaderButton>
